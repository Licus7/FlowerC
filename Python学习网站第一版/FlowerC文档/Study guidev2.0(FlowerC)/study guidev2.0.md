...
| 资源名称 | 链接 | 时长 | 难度 | 重点内容 | 推荐指数 |
|---------|------|------|------|---------|----------|
| Software Engineering Crash Course | [YouTube链接](https://www.youtube.com/watch?v=O753uuptq50) | 16min | 🟢 初级 | 软件工程概览 | ⭐⭐⭐⭐⭐ |
| 为什么软件项目会失败 | [YouTube链接](https://www.youtube.com/watch?v=RhdlBHHimeM) | 25min | 🟢 初级 | 项目失败分析 | ⭐⭐⭐⭐ |
| 软件开发生命周期 | [YouTube链接](https://www.youtube.com/watch?v=Wt4lZPl0p8c) | 20min | 🟢 初级 | 开发流程详解 | ⭐⭐⭐⭐ |

#### 开发过程与方法

| 资源名称 | 链接 | 时长 | 难度 | 重点内容 | 推荐指数 |
|---------|------|------|------|---------|----------|
| 瀑布vs敏捷直观对比 | [YouTube链接](https://www.youtube.com/watch?v=K1X1q-Gbd0A) | 18min | 🟡 中级 | 过程模型对比 | ⭐⭐⭐⭐⭐ |
| Scrum实战演示 | [YouTube链接](https://www.youtube.com/watch?v=vuBFzAdaHDY) | 25min | 🟡 中级 | Scrum框架实践 | ⭐⭐⭐⭐⭐ |
| 敏捷开发误区 | [YouTube链接](https://www.youtube.com/watch?v=Z9QbYZh1YXY) | 22min | 🟡 中级 | 敏捷实践陷阱 | ⭐⭐⭐⭐ |

#### 需求分析与设计

| 资源名称 | 链接 | 时长 | 难度 | 重点内容 | 推荐指数 |
|---------|------|------|------|---------|----------|
| 需求工程概述 | [YouTube链接](https://www.youtube.com/watch?v=Al6Yawu2t-c) | 30min | 🟡 中级 | 需求分析全过程 | ⭐⭐⭐⭐ |
| 用户故事编写技巧 | [YouTube链接](https://www.youtube.com/watch?v=apOvF9NVdBA) | 15min | 🟢 初级 | 用户故事实战 | ⭐⭐⭐⭐ |
| 软件架构模式详解 | [YouTube链接](https://www.youtube.com/watch?v=Ztvem6Iaa6c) | 35min | 🔴 高级 | 架构模式对比 | ⭐⭐⭐⭐⭐ |

#### 编码与测试

| 资源名称 | 链接 | 时长 | 难度 | 重点内容 | 推荐指数 |
|---------|------|------|------|---------|----------|
| 重构实战演示 | [YouTube链接](https://www.youtube.com/watch?v=example1) | 28min | 🟡 中级 | 重构技巧 | ⭐⭐⭐⭐ |
| TDD入门教程 | [YouTube链接](https://www.youtube.com/watch?v=example2) | 32min | 🟡 中级 | 测试驱动开发 | ⭐⭐⭐⭐⭐ |
| Git版本控制精通 | [YouTube链接](https://www.youtube.com/watch?v=example3) | 40min | 🟡 中级 | Git高级技巧 | ⭐⭐⭐⭐ |

### 🌐 在线教程与文档

#### 综合学习平台

| 资源名称 | 链接 | 特点 | 适合人群 | 主要内容 |
|---------|------|------|---------|---------|
| 🎯 GeeksforGeeks软件工程专题 | [访问链接](https://www.geeksforgeeks.org/software-engineering/) | 概念解释清晰，配有代码示例 | 概念学习和代码实践结合 | 从基础概念到高级主题全覆盖 |
| 📖 TutorialsPoint完整教程 | [访问链接](https://www.tutorialspoint.com/software_engineering/) | 系统化教程，结构完整 | 初学者系统学习 | 按软件开发生命周期组织 |
| 🔧 MDN Web文档 | [访问链接](https://developer.mozilla.org/) | 权威的Web技术文档 | 前端和后端开发参考 | HTML、CSS、JavaScript等 |

#### 专业文档与标准

| 资源名称 | 链接 | 特点 | 适合人群 | 主要内容 |
|---------|------|------|---------|---------|
| 🏛️ 软件工程知识体系SWEBOK | [访问链接](https://www.computer.org/education/bodies-of-knowledge/software-engineering) | IEEE权威发布的软件工程知识体系 | 深入学习和研究参考 | 软件工程全领域知识结构 |
| 🚀 敏捷宣言官方网站 | [访问链接](https://agilemanifesto.org/) | 敏捷开发基本原则和价值观 | 理解敏捷开发思想 | 四大价值观和十二原则 |
| 📊 IEEE软件工程标准 | [访问链接](https://standards.ieee.org/) | 行业标准文档 | 专业开发和标准化参考 | 各种软件工程标准和规范 |

### 🛠️ 实用工具集

#### 开发与设计工具

| 工具类型 | 推荐工具 | 特点 | 适用场景 | 学习资源 |
|---------|----------|------|----------|----------|
| 绘图设计 | 🎨 Draw.io | 免费、在线、易用 | 架构图、流程图 | [教程](https://www.drawio.com/doc/) |
| 项目管理 | 📋 Trello | 可视化看板 | 敏捷项目管理 | [指南](https://trello.com/guide) |
| 代码托管 | 💾 GitHub | 社区活跃、功能完整 | 版本控制、协作 | [学习实验室](https://lab.github.com/) |
| 文档协作 | 📝 Notion | 多功能、模板丰富 | 需求文档、知识库 | [模板库](https://www.notion.so/templates) |

#### 测试与质量工具

| 工具类型 | 推荐工具 | 特点 | 主要用途 | 学习曲线 |
|---------|----------|------|----------|----------|
| 单元测试 | 🐍 pytest | 简洁语法、功能强大 | Python单元测试 | 🟢 简单 |
| 自动化测试 | 🌐 Selenium | 跨浏览器测试 | Web自动化测试 | 🟡 中等 |
| 代码质量 | 🔍 SonarQube | 静态代码分析 | 代码质量检测 | 🟡 中等 |
| API测试 | 📮 Postman | 可视化接口测试 | API开发和测试 | 🟢 简单 |

#### 建模与设计工具

| 工具名称 | 类型 | 主要功能 | 适用场景 |
|---------|------|----------|----------|
| Visual Paradigm | 商业 | UML建模、架构设计 | 专业架构设计 |
| StarUML | 开源 | UML图表绘制 | 学习和小型项目 |
| Lucidchart | 在线 | 流程图、架构图 | 团队协作设计 |
...
定义：以迭代、增量的方式快速响应变化的开发方法
特点：强调个体互动、可工作软件、客户合作、响应变化
相关概念：Scrum、看板、极限编程
应用场景：需求变化快的创新项目

架构模式 (Architecture Pattern)
定义：软件系统的高级组织策略和结构模板
常见模式：分层架构、微服务、事件驱动、管道过滤器
作用：提供可重用的解决方案，指导系统设计

验收测试 (Acceptance Testing)
定义：验证系统是否满足用户需求和业务要求的测试
执行者：最终用户或业务代表
目的：确认软件可以交付使用

#### B
黑盒测试 (Black-Box Testing)
定义：基于软件功能规格的测试方法，不关注内部实现
测试重点：输入输出行为、功能正确性
技术：等价类划分、边界值分析
优势：从用户视角验证功能

边界值分析 (Boundary Value Analysis)
定义：针对输入边界点设计测试用例的测试技术
原理：错误更容易发生在边界条件
示例：测试最小值、最大值、边界值±1

分支覆盖 (Branch Coverage)
定义：白盒测试中要求执行所有分支的覆盖准则
目标：确保每个判断条件的真假分支都被执行
覆盖程度：中等覆盖率要求

#### C
重构 (Refactoring)
定义：改进代码内部结构而不改变外部功能的行为
目的：提高代码可读性、可维护性
原则：小步进行、保持测试通过

持续集成 (Continuous Integration)
定义：频繁将代码变更集成到主干分支的开发实践
流程：自动构建、自动测试、快速反馈
好处：早期发现问题，减少集成风险

耦合 (Coupling)
定义：模块间依赖程度的度量
类型：数据耦合、控制耦合、公共耦合、内容耦合
设计目标：低耦合、高内聚

#### D
单元测试 (Unit Testing)
定义：测试单个代码单元（函数、方法）的测试方法
范围：隔离测试，不依赖外部资源
...
维护 (Maintenance)
定义：软件交付后的修改和增强活动
类型： corrective（修正）、adaptive（适应）、perfective（完善）
成本：通常占软件生命周期成本的60-80%
...
活动：Sprint计划、每日站会、Sprint评审、Sprint回顾
...
### 🔤 术语分类索引
开发过程
瀑布模型、敏捷开发、增量模型、螺旋模型、Scrum

设计与架构
架构模式、设计模式、面向对象设计、UML、耦合、信息隐藏

测试与质量
单元测试、黑盒测试、白盒测试、验收测试、测试驱动开发
...
1.在软件开发中，“瀑布模型”的一个主要缺点是？
A. 缺乏详细的文档
B. 难以适应需求的变化
C. 测试开始得太晚
D. 客户参与度过高

2.“一个模块只负责一个明确的功能”描述的是以下哪个设计原则？
A. 开闭原则
B. 里氏替换原则
C. 单一职责原则
D. 接口隔离原则
...
3.下列哪项属于“非功能需求”？
A. 用户必须能够查询订单状态
B. 系统必须在1000个用户并发访问时，响应时间小于3秒
C. 系统必须提供用户注册和登录功能
D. 支付成功后必须生成电子收据

4.在面向对象设计中，我们优先使用“组合”而非“继承”的主要原因是为了？
A. 提高代码的执行效率
B. 减少类的数量
C. 降低类之间的耦合度
D. 实现代码的重用

5.将程序视为一个不透明的盒子，只检查输入输出是否符合规格说明的测试方法是？
A. 单元测试
B. 白盒测试
C. 黑盒测试
D. 集成测试

6.在软件项目中，用来识别、评估和控制变更的正式过程被称为？
A. 风险管理
B. 配置管理
C. 需求跟踪
D. 变更控制

7.UML中，下面哪种关系表示一种强的“整体-部分”关系，部分不能脱离整体而存在？
A. 关联
B. 依赖
C. 聚合
D. 组合

8.以下哪项是“敏捷开发”的核心实践之一？
A. 详尽的预先设计
B. 严格的阶段评审
C. 短周期的迭代开发
D. 最低限度的客户参与

9.一个模块内部各元素彼此结合的紧密程度，称为？
A. 耦合度
B. 内聚性
C. 独立性
D. 复杂度

10.在软件维护中，为了改进软件的性能、可维护性或可靠性而修改软件的过程，称为？
A. 纠正性维护
B. 适应性维护
C. 完善性维护
D. 预防性维护
...
1.( ) 在软件开发中，修复一个缺陷的成本随着发现阶段的后移而显著增加。

2.( ) “快速原型模型”的主要目的是为了最终交付一个可抛弃的演示系统。

3.( ) 在面向对象设计里，“依赖倒置原则”要求高层模块不应依赖低层模块，二者都应依赖于抽象。

4.( ) 软件工程只关心技术实现，不涉及管理活动。

5.( ) “集成测试”的主要目的是发现单个模块内部的逻辑错误。

6.( ) “用例图”是UML中用于描述系统静态结构的图表。

7.( ) “软件配置管理”的主要目标是管理软件开发过程中所有变化的工作产品。

8.( ) “高耦合”和“低内聚”是高质量软件设计的理想特征。

9.( ) “软件危机”指的是软件开发过程中遇到的无法解决的技术难题。

10.( ) 迭代开发的一个缺点是相对于其他开发模型，此模型

### 综合题
1.迭代开发克服了瀑布模型的哪两个限制？对于需求方来说有什么好处？

2.在软件设计中，我们追求“高内聚，低耦合”。请简要说明两者为何重要？

3.分别说出单元测试和集成测试在测试对象、测试目的这两个方面上的不同，并指出黑盒测试与白盒测试分别更适用于前面哪个测试以及原因（黑盒测试与白盒测试的特点）。
...
### 综合题参考答案
1.依照课本，迭代开发克服了以下两个限制：
1）采用瀑布模型时**整个软件是“大爆炸式”最后一次性交付**，开发途中**有巨大的项目风险与不确定性**，具有“全有或全无All or nothing”的价值命题；
2）**鼓励“需求膨胀”**，只能在**阶段开始时就指定所有需求**，**需求变更困难**；
对用户的好处：早期便可获得可用核心功能；需求的变更加灵活等等

2.高内聚使人易懂，低耦合让人敢改：高内聚使单个模块内部元素紧密相连，使**模块易于理解**；低耦合使不同的**模块间相对独立互不干扰**，使整体更加有序，不会牵一发而动全身。

3.两者的不同：
1）测试对象：单元测试的对象为单个的程序模块（如函数、类）；集成测试的对象则是已经进行集成后的模块
2）测试目的：单元测试是为了检查单个部分的可运行性，而集成测试则是测试各部分集成后是否可以正常运行
白盒测试更适用于单元测试，因为需要检查代码结构与逻辑问题，需要对照源代码；
黑盒测试更适用于集成测试，在集成测试中更注重模块外部表现和交互行为，只关心输入与输出是否符合规格说明
